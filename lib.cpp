    ...
    ui(new Ui::lib)
{
    ...
    if(qry.value("user_role").toString().compare("reader")==0||qry.value("user_role").toString().compare("librarian")==0) ui->admin->setVisible(false);
    if(qry.value("user_role").toString().compare("admin")==0||qry.value("user_role").toString().compare("reader")==0) ui->library->setVisible(false);
    if(qry.value("user_role").toString().compare("admin")==0||qry.value("user_role").toString().compare("librarian")==0) ui->history->setVisible(false);
    if(qry.value("user_role").toString().compare("admin")==0||qry.value("user_role").toString().compare("librarian")==0) ui->message->setVisible(false);
    if(qry.value("user_role").toString().compare("admin")==0||qry.value("user_role").toString().compare("librarian")==0) ui->contact->setVisible(false);
    if(qry.value("user_role").toString().compare("admin")==0||qry.value("user_role").toString().compare("reader")==0) ui->lib_message->setVisible(false);
    if(qry.value("user_role").toString().compare("admin")==0||qry.value("user_role").toString().compare("reader")==0) ui->request->setVisible(false);
    QSqlQuery qry1(db);
